...
\newcommand{\restriccion}[5]{
   \item{ \ifthenelse{\equal{#4}{d}}{ $#1.#3$ debe estar en $#2.#3$}{$#1.#3$ puede no estar en $#2.#3$}}\item{ \ifthenelse{\equal{#5}{d}}{$#2.#3$ debe estar en $#1.#3$}{$#2.#3$ puede no estar en $#1.#3$}}
    }
